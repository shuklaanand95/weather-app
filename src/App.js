...
function App() {
  ...
  const enterKeyPressed = (e) => {
    if(e.keyCode === 13){
      ...
      // e.currentTarget.blur(); //anand = " designerd web"
    }
  }
  ...
  const apiKey = "08ec955de19d5c3d789b75a478510c62";
  ...
  return (
    <div className=" w-[100%]  h-[100%] bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... ">
      ...
      {/* {forecast.length > 0 && ( */}
        <h2 className="text-5xl font-bold flex flex-row justify-center items-center ">6-Times Forecast</h2>
        <h1 className="flex flex-row justify-center  from-pink-500 hover:to-yellow-500">Created by Anand Shukla And Team</h1>
      <div className=" p-10  ">
